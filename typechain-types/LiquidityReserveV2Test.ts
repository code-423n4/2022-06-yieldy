...
export interface LiquidityReserveV2TestInterface extends utils.Interface {
  functions: {
...
export interface LiquidityReserveV2Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LiquidityReserveV2TestInterface;
